...
// lines for split times, start and finish lines, side walls, and thin horizontal lines
    ...
    for (i = 0; i < 4; i++) {
        // far wall
        rect(beginnings[i] + 8 * laneOffset - trackPadding, startHeight-farWallHeight, courseLength + 2*trackPadding, farWallHeight)
        quad(beginnings[i] + 8 * laneOffset - trackPadding + wallDepth, startHeight-farWallHeight - wallWidth, beginnings[i] + 8 * laneOffset - trackPadding + wallDepth + courseLength + 2*trackPadding,      startHeight-farWallHeight - wallWidth,
            beginnings[i] + 8 * laneOffset - trackPadding + courseLength + 2*trackPadding, startHeight-farWallHeight, beginnings[i] + 8 * laneOffset - trackPadding, startHeight-farWallHeight)        
        quad(beginnings[i] + 8 * laneOffset - trackPadding + courseLength + 2*trackPadding,      startHeight-farWallHeight,
            beginnings[i] + 8 * laneOffset - trackPadding + wallDepth + courseLength + 2*trackPadding,      startHeight-farWallHeight - wallWidth,
            beginnings[i] + 8 * laneOffset - trackPadding + wallDepth + courseLength + 2*trackPadding,      startHeight-farWallHeight - wallWidth + nearWallHeight,
            beginnings[i] + 8 * laneOffset - trackPadding + courseLength + 2*trackPadding,      startHeight-farWallHeight + nearWallHeight)
            
        // near wall
        rect(beginnings[i] - trackPadding - 4, startHeight + 8 * rowHeight + wallWidth, courseLength + 2*trackPadding, nearWallHeight)
        quad(beginnings[i] - trackPadding - 4 +  wallDepth, startHeight + 8 * rowHeight, beginnings[i] - trackPadding -4 + wallDepth + courseLength + 2*trackPadding, startHeight + 8 * rowHeight,
            beginnings[i] - trackPadding -4 + courseLength + 2*trackPadding, startHeight + 8 * rowHeight + wallWidth, beginnings[i] - trackPadding - 4, startHeight + 8 * rowHeight + wallWidth)
